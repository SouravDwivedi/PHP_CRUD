...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <a class="navbar-brand" href="crud.html">READ DATABASE</a>
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="crud.html">Insert</a></li>
                    <li class="nav-item"><a class="nav-link" href="crud.html">Delete</a></li>
                    <li class="nav-item"><a class="nav-link" href="crud.html">Update</a></li>
                </ul>
